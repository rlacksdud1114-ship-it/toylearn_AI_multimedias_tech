...
sheet형식 말고 markdown 코드블럭을 써서 편집기에 넣는 형식으로 주고, 출처표시는 다 지워주고
사이트도 넣지마 
...
**수신:** 고객사 내부 관리자/임원
**발신:** 김찬영 (전략적 의사소통 및 문서화 전문가)
**날짜:** 2025년 10월 22일

존경하는 [고객사 이름] 임원 및 관리자 여러분,

초록숲 재단과의 '내 숨을 위한 한 평의 숲' 공익 캠페인 킥오프 미팅 결과를 아래와 같이 요약하여 보고 드립니다. 논의된 핵심 결정 사항과 향후 실행 계획을 확인하시어 원활한 내부 승인 절차를 진행해 주시기를 요청드립니다.
...
* **참석자:**
    * 초록숲 재단: 김선우 사무국장, 이지수 캠페인 매니저
    * 유어미디어: 김민준 캠페인 전략팀장, 이수영 크리에이티브 디렉터
* **주요 안건:** 캠페인 핵심 메시지, 크리에이티브 방향성, 예산 내 실행 전략 및 제안서 제출 일정 확정

**2. 회의 주요 결정 사항 (회의록 요약)**

* **캠페인 콘셉트 관련 결정:** 최종 크리에이티브 콘셉트는 **“숨결이 모여 숲이 될 때”**로 확정되었습니다. 이는 ‘연대감’과 ‘희망’이라는 핵심 키워드를 반영한 다큐멘터리형 영상 기반입니다.
* **제작 포맷 관련 결정:** 메인 영상 포맷은 **30초 다큐멘터리형** 중심으로 진행하여 공익 캠페인의 진정성을 극대화하기로 결정되었습니다.
* **주요 가격 정책 결정 (예산 및 전략):**
    * **최종 결정된 프로젝트 예산:** ₩50,000,000 (총 5천만 원 한도)
    * **가격 책정 모델/전략:** **'예산 최적화 기반 미디어 후원 확보 전략'**을 채택했습니다. 5천만 원 예산은 고품질 다큐멘터리 영상 제작(당사 Standard 등급 범위 내)에 집중 투입되며, 광범위한 송출 및 도달 목표는 **PSA(공익광고) 및 ESG 연계 미디어 후원 유치**를 통해 달성하여, 한정된 예산의 효율을 극대화할 것입니다.

**3. 향후 실행 계획 (Action Items)**

| 실행 항목 (Action Item) | 담당자 | 완료 기한 |
| :--- | :--- | :--- |
| 캠페인 제안서 및 견적서 작성 후 발송 | 김민준 (유어미디어) | 2025년 10월 24일 (금) |
| 크리에이티브 시안 및 영상 콘셉트 시각화 작업 완료 | 이수영 (유어미디어) | 2025년 10월 23일 (목) |
| 초록숲 재단 내부 검토 및 승인 절차 준비 | 이지수 (초록숲 재단) | 2025년 10월 25일 (토) |

**4. 마무리**

상세 제안서 및 견적서는 금일 중으로 작성하여 10월 24일(금)에 공유 드릴 예정입니다. 본 보고서 내용과 관련하여 추가적인 질문이나 내부 조율 사항이 있으시면 언제든지 회신 주시기 바랍니다.
...
지난 10월 23일에 진행된 더 어반 십 '스파클링 아이스티' 론칭 캠페인 킥오프 미팅 결과를 핵심 결정 사항 위주로 간결하게 보고 드립니다.
...
* **참석자:**
    * 더 어반 십: 박서준 마케팅팀장, 최지혜 브랜드 매니저
    * 유어미디어: 김민준 캠페인 전략팀장, 이수영 크리에이티브 디렉터
* **주요 안건:** 론칭 캠페인 콘셉트 확정, 예산 배분 구조, 매체 전략, KPI 측정 방안 최종 논의

**2. 회의 주요 결정 사항 (회의록 요약)**

* **크리에이티브 콘셉트 관련 결정:** 2040 직장인 타겟의 '세련된 휴식'이라는 브랜드 키워드를 반영하여, 광고 콘셉트는 **“Urban Oasis(도심 속 오아시스)”**로 최종 확정되었습니다.
* **KPI 및 측정 방식 결정:** 캠페인 목표 KPI는 **'수도권 인지도 30% 상승'**으로 설정되었으며, 달성 여부는 전문 리서치 기관을 통한 사전/사후 인지도 조사 방식으로 측정하기로 결정되었습니다.
* **주요 가격 정책 결정 (예산 및 전략):**
    * **최종 결정된 예산 구조:** 총 2억 원 내에서 **제작비 5천만 원** / **매체비 1억 5천만 원**으로 배분 확정.
    * **가격 책정 모델/전략:** **'High-Reach 방송 중심의 Balanced Investment Strategy'**를 채택했습니다. 제작비 5천만 원은 프리미엄 감성 광고를 위한 당사의 Standard TV CF 제작 범위에 부합하며, 매체비 1억 5천만 원은 KPI 달성을 위해 TV(tvN, JTBC 중심) 및 라디오 등 **광역 매체(Broadcast Media)**에 집중 집행하여 수도권 인지도를 공격적으로 확보할 것입니다.

**3. 향후 실행 계획 (Action Items)**

| 실행 항목 (Action Item) | 담당자 | 완료 기한 |
| :--- | :--- | :--- |
| 공식 제안서, 구체적인 매체 계획안 작성 및 발송 | 김민준 (유어미디어) | 2025년 10월 28일 (화) |
| ‘Urban Oasis’ 콘셉트의 핵심 비주얼 시안 제작 | 이수영 (유어미디어) | 2025년 10월 27일 (월) |
| 더 어반 십 내부 검토 및 승인 절차 준비 | 박서준 (더 어반 십) | 2025년 10월 29일 (수) |
| KPI 측정 전문 리서치 업체 선정 및 프로세스 협의 | 최지혜 (더 어반 십) | 2025년 10월 30일 (목) |

**4. 마무리**

최종 제안서와 구체적인 매체 스케줄은 10월 28일(화)에 제출될 예정입니다. 내부적으로 결정된 사항을 검토하시고, 10월 31일 예정된 후속 회의 전까지 승인 및 관련 피드백을 주시면 감사하겠습니다.
